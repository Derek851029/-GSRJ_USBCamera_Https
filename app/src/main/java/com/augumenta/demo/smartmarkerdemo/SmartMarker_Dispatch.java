...
//                webView.loadUrl("https://210.68.227.123:8030/mISSION/MissionContext/87?sysid=87");
//                return true;
//            }
...
//        webView.loadUrl("https://210.68.227.123:8030/mISSION/MissionContext/87?sysid=87");
        ...
        // You can get your markers from: https://getsmartmarker.augumenta.com
        ...
        public void run() {
            if(DispatchSystem.equals("")){
                try {
                    ...
                    HttpGet httpGet = new HttpGet("https://"+IP + "/Api/DispatchSystems/"+DispatchSystem);
